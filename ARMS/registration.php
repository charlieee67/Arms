...
if($_SERVER["REQUEST_METHOD"]==="POST"){
    ...
    $sql=$conn->prepare("insert into register (username,email,password) values (?,?,?)");
...
<html lang="en">
    ...
    <body class="bg-black">
             ...
             />
                ...
                <div class="collapse navbar-collapse text-center" id="collapsibleNavId">
                    =  <ul class="navbar-nav w-100 justify-content-around mt-2 mt-lg-0 text-center" style="color: aliceblue;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" style="color: aliceblue;font-family: 'Lucida Sans' ; font-size: larger ; font-weight: 300;"  href="login.html">click here to Log-in, If you already Registered</a>
                            </li>  
        ...
        <main>
               ...
               <center><h3 class="text-white " style="font-family: 'Franklin Gothic Medium';">Registration</h3></center>
                <div
